...
// The nested function can acces the variable internal because that function is inside of my function. Because of this there are local variables that can be accessed allowing internal to be console.logged. Internal of course being a local variable.
